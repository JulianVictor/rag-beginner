...
# Store ourt conversation as messages
chat_history = []
...
def ask_question(user_question):
    ...
    # Step 2: Find relevant documents from the vector store
    ...
    messages = [
    SystemMessage(content="You are a helpful assistant that answer question based on provided documents and conversation.")
    ] + chat_history + [
    ...
    # Step 5: Remember thsi conversation
